...
export default function BookmarkedProfilesPage() {
  ...
  return (
    <>
      <Seo
        title="Bookmarked Profiles – Your Saved TalentDeck Favorites"
        description="Access all your bookmarked TalentDeck profiles in one place. Quickly revisit top creators and talents you’ve saved for later."
        url="https://talentdeck-next.netlify.app/bookmarks"
      />
