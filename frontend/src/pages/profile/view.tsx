...
const ViewProfile = () => {
  ...
  return (
    <>
      <Seo
        title="My TalentDeck Profile – Projects, Skills & Work Showcase"
        description="View your full TalentDeck profile — complete with your bio, skills, availability, and projects. Built to highlight your unique talent."
        url="https://talentdeck-next.netlify.app/view"
      />
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-6 border-b pb-6">
          ...
          <div className="flex-1">
            ...
            <div className='flex gap-4 items-center'>
              ...
              <div className='flex items-center gap-2 mt-1.5 h-fit text-gray-500 dark:text-gray-300'>
                {likesCount > 0 && <AiFillLike size={22} />} {likesCount} {likesCount > 1 ? "Likes" : "Like"}
              </div>
            </div>
          </div>
        </div>
