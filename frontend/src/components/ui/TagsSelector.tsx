...
const TagsSelector: React.FC<TagsSelectorProps> = ({ name, setValue, watch, error }) => {
    ...
    return (
        <div className="mb-4 w-full">
            <label className="block text-base text-black font-medium mb-1">Tags <span className="text-gray-500">(optional)</span></label>
            ...
            {tags.length > 0 && (
                <div className="flex flex-wrap gap-2">
                    {tags.map((tag) => (
                        ...
                        >
                            {tag}
                            <button type="button" onClick={() => handleRemoveTag(tag)} className="ml-2 text-gray-600 hover:text-red-500">
